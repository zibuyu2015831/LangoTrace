...
| Mac Sidebar | 在 Today、Entries、Reading、Practice、Memory、Import / Export、Settings 间切换 | 左侧 Sidebar | Implemented | `MacWorkspaceSection`、`MacSidebarItem` | Reading section 进入真实资料库 route；其他 section selection 不直接创建业务数据 | 不使用移动端 Tab；hover、focus、context menu 需保留 |
