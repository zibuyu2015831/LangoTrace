...
- 将审查机制纳入现有 `docs/README.md`、`docs/documentation-system.md` 和 `docs/worklogs/README.md` 的规则体系。
...
- 视需要在 `docs/worklogs/README.md` 中补充“文档影响检查”要求，要求重要开发任务完成时记录文档是否需要更新。
...
- 检查 `docs/worklogs/README.md` 是否能指导后续任务记录文档影响。
...
2026-05-17：更新 `docs/worklogs/README.md` 和 `docs/worklogs/TEMPLATE.md`，把“文档影响检查”纳入重要任务收尾流程。
...
- 已影响 `docs/worklogs/README.md`：新增文档影响检查要求。
- 已影响 `docs/worklogs/TEMPLATE.md`：新增“文档影响检查”章节。
...
```bash
rg -n "文档审查|docs/review|review/README|review/INDEX|文档影响检查|专项审查|里程碑轻量全审" docs/README.md docs/documentation-system.md docs/worklogs/README.md docs/worklogs/TEMPLATE.md docs/review/README.md docs/review/INDEX.md docs/review/rounds/README.md docs/worklogs/2026-05-17-chore-docs-review-mechanism.md
rg -n "四类文档分级|verified_at|季度|月度|case_skillatlas_review" docs/README.md docs/documentation-system.md docs/worklogs/README.md docs/worklogs/TEMPLATE.md docs/review docs/worklogs/2026-05-17-chore-docs-review-mechanism.md
```

结果：

- 文档审查相关入口在 `docs/README.md`、`docs/documentation-system.md`、`docs/worklogs/README.md`、`docs/worklogs/TEMPLATE.md` 和 `docs/review/` 中均有对应落点。
...
```bash
rg -n "审查类型：|docs/review/README.md|review/" docs/README.md docs/documentation-system.md docs/worklogs/README.md docs/worklogs/TEMPLATE.md docs/review docs/worklogs/2026-05-17-chore-docs-review-mechanism.md
```
