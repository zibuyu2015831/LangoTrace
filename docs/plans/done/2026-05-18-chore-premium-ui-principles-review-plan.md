...
- 新增 `docs/spec/ui-design/2026-05-18-premium-ui-principles-and-review-plan.md`。
...
- 占位词扫描无命中。
- `git diff --check` 通过。
- `git status --short` 显示本次新增规格、worklog 和 specs README 修改；另有既存未提交文档改动 `docs/plans/done/2026-05-18-bug-interface-language-settings-detail-localization.md`，本次未修改。
...
```bash
rg -n "^## |^### " docs/spec/ui-design/2026-05-18-premium-ui-principles-and-review-plan.md
rg "TO[D]O|TB[D]|待补[充]|稍后完[善]|以后再[写]|待[定]" docs/spec/ui-design/2026-05-18-premium-ui-principles-and-review-plan.md docs/plans/done/2026-05-18-chore-premium-ui-principles-review-plan.md
```
