...
- 新增 `docs/spec/ui-design/mvp-ui-flow-and-design-system.md`，作为后续页面补全与设计系统升级规格。
- 新增 `docs/archive/superpowers/plans/2026-05-17-mvp-ui-flow-and-design-system-implementation.md`，记录第一批实施任务和验证。
...
- 本 worklog 作为封面记录。
- `docs/spec/ui-design/mvp-ui-flow-and-design-system.md` 作为设计规格。
- 代码实现前创建 `docs/archive/superpowers/plans/2026-05-17-mvp-ui-flow-and-design-system-implementation.md`，拆成可验证任务。
...
- 新增 `docs/spec/ui-design/mvp-ui-flow-and-design-system.md`，沉淀优化规格。
