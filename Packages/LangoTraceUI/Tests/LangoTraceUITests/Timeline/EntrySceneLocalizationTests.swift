...
@Suite("Entry scene localization")
struct EntrySceneLocalizationTests {
    /// Scene copy follows the surrounding convention of shipping the source language
    ...
    @Test("New scene keys are distinct")
